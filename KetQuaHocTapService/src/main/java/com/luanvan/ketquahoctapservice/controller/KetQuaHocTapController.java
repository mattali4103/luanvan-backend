...
//    Private API
    ...
    public ApiResponse<List<KetQuaHocTapDetail>> getHocPhanCanCaiThienByMaSo(@PathVariable String maSo) {
    ...
    public ApiResponse<List<KetQuaHocTapDetail>> getKetQuaHocTapByDiemChuF(@PathVariable String maSo) {
        return ApiResponse.<List<KetQuaHocTapDetail>>builder()
                .code(200)
                .message("OK")
